      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 200) {
            alerts.showAlert('success', 'Login successful');
        ...
        case 7:
          ...
          alerts.showAlert('error', _context.t0.es.data.message);
        case 10:
        case "end":
...
},{"@babel/polyfill":"../../node_modules/@babel/polyfill/lib/index.js","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"mapBox.js":[function(require,module,exports) {
/* eslint-disable */

exports.displayMap = function (location) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWRuYW50YWoiLCJhIjoiY2x1aWk4NGNsMDU1dDJrbnljc3czMWg4cCJ9._HVsWw5u8ZjBkYSKFXqRdA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/adnantaj/cluix6ffr01al01pr53um1mcv',
    // style URL
...
// DELEGATION
if (mp) {
  var locations = JSON.parse(mp.dataset.locations);
